...
Mutating live harness — gated by tests/preflight.py like every other live_*.
Run:  .venv/bin/python tests/live_resolve20_api.py
"""
...
# Resolve's Scripting module lives at a per-platform path; src.core.platform
# resolves it for macOS/Linux/Windows. The old hard-coded macOS-only
# sys.path.insert was a no-op everywhere else, and importing the module at
# import time made this file un-collectable on any Resolve-less machine.
