# Audio / Fairlight — Context (ICM Layer 3, stub)

Domain-specific code for **Audio / Fairlight** (restructure epic #52). This is a stub —
...
- `utils/audio_fairlight_live_probe.py`
- `utils/subtitle_codec.py`

## Depth

- Kernel: `docs/kernels/audio-fairlight-kernel.md`
- Claude Code skill: `.claude/skills/` (`resolve-audio-fairlight`)
