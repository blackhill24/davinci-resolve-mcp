...
def _install_mcp_stubs() -> None:
    ...
    def stdio_server(*args, **kwargs):
        raise RuntimeError("stdio_server is not used by the live Extension Authoring probe")
...
def main() -> int:
    ...
    from src.domains.extension_authoring.utils.extension_authoring_live_probe import run_probe  # noqa: WPS433
