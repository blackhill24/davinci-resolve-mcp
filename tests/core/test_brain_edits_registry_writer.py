...
class TimelineFpsConventionTest(unittest.TestCase):
    ...
    def test_duration_is_computed_rather_than_silently_dropped(self):
        # 48 frames at 24 fps: GetEndFrame() is EXCLUSIVE (#141 finding 6,
        # measured live). What matters here is that a formatted fps setting
        # yields a NUMBER at all rather than None.
