...
from src.domains.media_analysis.utils.embeddings import pack_vector as _pack_vector
from src.domains.media_analysis.utils.embeddings import unpack_vector as _unpack_vector
