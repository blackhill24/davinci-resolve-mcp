...
| Auto-edit pipeline tests | `test_auto_edit.py`, `test_auto_edit_tool.py`, `test_cut_ir_words.py`, `test_music_analysis.py` | `live_auto_edit_validation.py` unless live | — |
