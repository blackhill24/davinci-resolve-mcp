...
from src.domains.media_analysis.utils import analysis_memory, analysis_store
...
def plan_swap(
    ...
    *,
    ...
    from src.domains.media_analysis.utils import shot_relationships as _shot_relationships
