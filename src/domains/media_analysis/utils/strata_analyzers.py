...
src/domains/media_analysis/utils/strata. All are optional-capability: they self-describe what they
...
def _face_capability() -> Dict[str, Any]:
    ...
    try:
        from src.domains.media_analysis.utils import strata_faces
