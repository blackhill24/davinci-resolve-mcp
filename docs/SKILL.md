...
```
.venv/bin/python tests/domains/media_pool_ingest/live_media_pool_ingest_validation.py --output-dir /tmp/media-pool-ingest-probe
```
...
```
.venv/bin/python tests/domains/review_annotation/live_review_annotation_validation.py --output-dir /tmp/review-annotation-probe
```
...
```
.venv/bin/python tests/domains/color_grade/live_color_grade_validation.py --output-dir /tmp/color-grade-probe
```
...
```
.venv/bin/python tests/domains/timeline_conform_interchange/live_timeline_conform_validation.py --output-dir /tmp/timeline-conform-probe
```
...
```
.venv/bin/python tests/domains/render_deliver/live_render_deliver_validation.py --output-dir /tmp/render-deliver-probe
```
...
(recount via `scripts/audit_api_parity.py --count`). 343 methods have been
